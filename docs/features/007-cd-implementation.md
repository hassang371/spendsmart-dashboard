...
| 2026-03-25 | ENHANCEMENT: Staging auto-rollback on smoke test failure — captures previous deployment before deploy, triggers serviceInstanceUpdate + serviceInstanceDeploy for both API and Worker services. Production rollback remains manual. |
