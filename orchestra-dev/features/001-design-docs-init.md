...
- **Eval scenarios (5 new, registered in skill-creator eval framework — framework lives at `orchestra/eval/scenarios/` and is loaded by `orchestra/eval/run.py` per existing v1.0 convention):**
