  ...
  return (
    <div className="min-h-screen bg-brand-light flex flex-col md:flex-row font-display selection:bg-brand-yellow selection:text-black">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 bg-brand-light relative">
        <Link
          href="/"
          className="absolute top-8 left-8 flex items-center gap-2 text-black/40 hover:text-black transition-colors font-sans font-bold uppercase tracking-widest text-xs"
        >
          ...
          {confirmationSent ? (
            <div className="space-y-4 text-center">
              <div className="p-6 bg-brand-green/20 border-2 border-brand-green rounded-xl">
                <h2 className="text-lg font-bold text-brand-green mb-2 font-display uppercase">
                  Check your email
                </h2>
              ...
              <Link
                href="/login"
                className="inline-block text-black hover:underline font-bold uppercase tracking-wide text-sm"
              >
                Back to Login
              </Link>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-4 font-sans">
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-xs uppercase font-bold tracking-widest">
                  <span className="bg-brand-light px-2 text-black/40">Or continue with</span>
                </div>
              </div>
