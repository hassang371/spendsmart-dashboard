...
export default function OverviewPage() {
  ...
  const periodExpenses = (() => {
    ...
    return data.filter(tx => {
      ...
      return (
        txLocalTime.getMonth() === now.getMonth() && txLocalTime.getFullYear() === now.getFullYear()
      );
    });
  })();
  ...
  const trendData: TrendData[] = useMemo(() => {
    ...
    while (cursor <= monthEnd) {
      ...
      const labelStart = bucketStart.toLocaleDateString('en-IN', {
        day: 'numeric',
        month: 'short',
      });
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex-shrink-0 mb-2 flex justify-between items-end"
      >
        <div>
        ...
        >
          ...
          <div className="relative z-10 max-w-lg">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Your financial dashboard is currently empty. Add your first transaction to unlock
              powerful insights and visualizations.
            </p>
            ...
            >
              ...
              <div className="w-[120px] h-[120px] relative flex-shrink-0 z-10">
                {topCategories.length === 0 ? (
                  <p className="text-muted-foreground text-[10px] italic absolute inset-0 flex items-center justify-center">
                    No data
                  </p>
                ) : (
                  ...
                  splurges.map((tx, i) => (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-xs font-bold text-foreground truncate group-hover:text-red-500 transition-colors">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1 ml-7">
                  {timeframe === 'weekly'
                    ...
                    : 'Weekly spending for this month'}
                </p>
              </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={trendData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <XAxis
                    ...
                    dy={10}
                  />
                  <Bar dataKey="amount" radius={[6, 6, 6, 6]} animationDuration={1500}>
