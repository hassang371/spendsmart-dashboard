...
export default function SettingsPage() {
  ...
  const handleDeleteAllData = async () => {
    ...
    try {
      ...
      setToast({
        type: 'error',
        message: deleteError instanceof Error ? deleteError.message : 'Failed to delete data.',
      });
    } finally {
            ...
            {isEditingProfile ? (
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <ChevronRight
                    size={16}
                    className="text-muted-foreground/50 opacity-0 transition-all group-hover/item:opacity-100 group-hover/item:translate-x-1"
                  />
                </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-border bg-muted/30 p-3 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-medium text-muted-foreground">
                    {mounted ? (theme === 'dark' ? 'Dark' : 'Light') : 'System'}
                  </p>
                </div>
              </div>
              <button
