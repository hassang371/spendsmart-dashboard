            ...
            <div className="flex-1 overflow-y-auto no-scrollbar p-6">
              <div className="flex flex-col gap-4">
                {recurringList.map((sub, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 rounded-2xl bg-background border border-border/50 hover:border-pink-500/30 transition-colors group"
                  >
                    <div className="flex items-center gap-4 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs text-muted-foreground font-medium truncate">
                          {sub.category} • Last charged {sub.date}
                        </p>
                      </div>
                    </div>
