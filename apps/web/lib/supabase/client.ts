...
try {
  supabaseUrl = getPublicEnvVar(process.env.NEXT_PUBLIC_SUPABASE_URL, 'NEXT_PUBLIC_SUPABASE_URL');
  ...
  if (typeof window !== 'undefined') {
    ...
    container.style.cssText =
      'display:flex;align-items:center;justify-content:center;height:100vh;font-family:system-ui;padding:2rem;text-align:center';
