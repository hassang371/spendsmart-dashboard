...
const Hero: React.FC = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[100vh] w-full overflow-hidden bg-brand-bg pt-20"
    >
      ...
      <div className="relative z-10 container mx-auto flex flex-col items-center justify-center h-full px-4 min-h-[80vh]">
        ...
        <motion.div
          style={{ y: textY }}
          className="relative z-20 text-center w-full flex flex-col items-center justify-center -space-y-4 md:-space-y-8"
        >
          <h1 className="font-display font-black text-[22vw] md:text-[25vw] leading-[0.8] tracking-tighter text-black select-none z-10 scale-y-125">
            SCALE
          </h1>
        </motion.div>
