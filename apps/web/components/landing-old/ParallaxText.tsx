    ...
    <section ref={containerRef} className="py-32 bg-white overflow-hidden relative">
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col gap-12 md:gap-24">
          ...
          <motion.div
            style={{ y: y2 }}
            className="flex items-center justify-center gap-4 md:gap-8 z-20"
          >
            <h2
              className="font-display text-8xl md:text-[12rem] font-black uppercase tracking-tighter leading-none text-brand-blue text-outline"
          ...
          <motion.div
            style={{ y: y3 }}
            className="flex items-center justify-end gap-4 md:gap-8 opacity-80"
          >
            <div className="w-24 h-24 md:w-32 md:h-32">
