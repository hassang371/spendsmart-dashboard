...
const tabs = [
  {
    ...
    title: 'Mobile App',
    description:
      'Track your spending on the fly. Snap receipts, categorize transactions, and get real-time AI alerts on your budget limits.',
  ...
  },
  {
    ...
    title: 'Web Dashboard',
    description:
      'A powerful command center for your finances. Deep dive into analytics, export reports, and manage your prediction settings.',
  ...
  },
  {
    ...
    title: 'AI Agent',
    description:
      'Your personal accountant, available 24/7. Ask questions, get tax advice, and let the AI model optimize your cash flow automatically.',
        ...
        <AnimatedSection>
          <div className="mb-16 flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
            <h2 className="font-display text-6xl font-bold uppercase tracking-tighter md:text-8xl leading-none text-black">
              SCALE IS ALWAYS <br />
              <span
                className="text-outline text-brand-blue"
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex-1 space-y-8 order-1 md:order-2">
                <h3 className="font-display text-8xl font-bold uppercase italic tracking-tight md:text-[8rem] leading-[0.8] text-black">
                  {activeTab.title}
                </h3>
                <p className="font-sans text-2xl font-bold leading-relaxed max-w-lg text-black">
                  {activeTab.description}
                </p>
                <Button variant="dark" icon className="text-xl px-8 py-4">
