      ...
      <div className="container mx-auto px-4">
        <div className="mb-20 flex flex-col items-center text-center">
          <AnimatedSection>
            ...
            <p className="font-display text-4xl font-bold uppercase md:text-5xl text-black">
              See for yourself.
            </p>
          </AnimatedSection>
        </div>
        ...
        <div className="relative -mx-4">
          ...
          <div className="flex gap-8 overflow-x-auto pb-20 pt-10 px-8 snap-x no-scrollbar">
            <div className="flex-none w-[350px] md:w-[500px] flex flex-col items-center justify-center rounded-[2.5rem] border-4 border-black bg-brand-yellow p-12 shadow-hard-lg text-center snap-center transform transition-transform hover:scale-105 hover:-rotate-2">
              <h3 className="font-display text-6xl font-bold uppercase italic leading-none">
                Trusted By
                <br />
                Millions
              </h3>
            ...
            {testimonials.map((t, i) => (
              <div
                key={i}
                className={`flex-none w-[350px] md:w-[500px] flex flex-col justify-between rounded-[2.5rem] border-4 border-black ${t.color} p-12 shadow-hard-lg snap-center transition-all duration-300 hover:-translate-y-4 hover:shadow-hard-xl ${t.rotation}`}
              >
                <p className="font-display text-4xl font-bold leading-[0.9] uppercase text-black">
                  &quot;{t.text}&quot;
                </p>
                <div className="mt-12 flex items-center gap-4">
                  ...
                  <p className="font-sans font-bold uppercase tracking-wide text-xl text-black">
                    {t.author}
                  </p>
                </div>
              </div>
