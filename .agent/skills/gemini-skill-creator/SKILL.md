...
description: Expert instructions for creating new Antigravity agent skills. Use this skill when the user asks to create or update a skill, ensuring all new skills follow the strict structure and best practices defined herein.
---
