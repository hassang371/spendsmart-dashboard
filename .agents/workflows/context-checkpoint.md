...
- When the anti-drift self-check triggers (before code or before claiming done)
...
The Global Rule's anti-drift self-check includes:

> "When context feels crowded or progress is unclear — checkpoint."

If you're losing track of what's been done or output quality is declining, the answer is YES. Read this workflow and execute the checkpoint.
