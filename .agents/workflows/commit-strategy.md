---
description: Commit standards for SCALE — read at session start. Defines conventional commit prefixes, mandatory Refs: rule, and pre-commit doc status updates.
---
