...
def check_pvcs(namespace: str) -> Dict[str, Any]:
    ...
    results = {"total": 0, "bound": 0, "pending": 0, "lost": 0, "issues": []}
...
def check_resource_quotas(namespace: str) -> Dict[str, Any]:
    ...
    results = {"total": 0, "near_limit": [], "exceeded": [], "issues": []}
                ...
                if limit_val > 0:
                    ...
                    if usage_percent >= 100:
                        ...
                        results["issues"].append(
                            f"Quota {name}: {resource} near limit ({usage}/{limit}, {usage_percent:.0f}%)"
                        )
