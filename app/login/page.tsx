                ...
                <div className="relative flex-1 flex flex-col items-center justify-center w-full max-w-[1600px] mx-auto">
                    ...
                    <div className="relative z-20 text-center w-full max-w-md px-4">
                        <div className="bg-white border-2 border-black p-8 md:p-12 rounded-[2.5rem] shadow-hard-lg relative overflow-hidden">
                            ...
                            <form onSubmit={handleLogin} className="flex flex-col gap-4 font-sans text-left relative z-10">
                                <input
                                    required
                                    value={email}
...
export default function LoginPage() {
    return (
        <React.Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-brand-light"><Loader2 className="w-8 h-8 animate-spin text-black" /></div>}>
            <LoginContent />
        </React.Suspense>
    );
}
