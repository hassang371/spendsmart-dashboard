      ...
      >
        ...
        <div className="hidden md:flex w-64 flex-col border-r border-gray-800 bg-[#0F1116] p-6">
            <div className="flex items-center gap-3 mb-10 text-white font-display text-2xl tracking-tight">
                <div className="h-8 w-8 rounded-full bg-brand-blue flex items-center justify-center">S</div>
                SCALE
            </div>
        ...
        <div className="flex-1 p-4 md:p-8 overflow-hidden flex flex-col bg-[#0A0C10]">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="hidden sm:flex bg-gray-800/50 rounded-full p-1 border border-gray-700">
                    <button className="px-6 py-2 bg-brand-blue text-white rounded-full text-sm font-bold shadow-lg">Weekly</button>
                    <button className="px-6 py-2 text-gray-400 hover:text-white rounded-full text-sm font-medium transition-colors">Monthly</button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1">
                ...
                <div className="bg-gradient-to-br from-brand-coral to-red-600 rounded-3xl p-6 text-white relative overflow-hidden shadow-lg shadow-brand-coral/20 group">
                    <div className="absolute top-0 right-0 p-4 opacity-50">
                        <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="transform group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div className="flex items-center justify-between flex-1">
                        ...
                        <div className="relative w-32 h-32 flex items-center justify-center">
                            <svg viewBox="0 0 100 100" className="w-full h-full transform -rotate-90">
                                ...
                                <circle cx="50" cy="50" r="40" fill="transparent" stroke="#4892FF" strokeWidth="12" strokeDasharray="150 251" strokeLinecap="round" />
                                <circle cx="50" cy="50" r="40" fill="transparent" stroke="#9F8BFF" strokeWidth="12" strokeDasharray="70 251" strokeDashoffset="-150" strokeLinecap="round" />
                                <circle cx="50" cy="50" r="40" fill="transparent" stroke="#FF4D4D" strokeWidth="12" strokeDasharray="30 251" strokeDashoffset="-220" strokeLinecap="round" />
                            </svg>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-[#13161C] border border-gray-800 rounded-3xl p-6 text-white shadow-lg flex flex-col">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-gray-800/30 border border-gray-700/50 hover:bg-gray-800/50 transition-colors">
                                <div className="flex items-center gap-3">
                                    <div className="h-8 w-8 rounded-lg bg-gray-700 flex items-center justify-center text-xs font-bold text-gray-400">{i+1}</div>
                                    <div>
                ...
                <div className="lg:col-span-3 bg-[#13161C] border border-gray-800 rounded-3xl p-6 text-white shadow-lg relative overflow-hidden">
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            ...
                            <p className="text-sm text-gray-400">Projected spend based on recurring vectors.</p>
                        </div>
                        ...
                        {[40, 65, 35, 80, 50, 90, 60].map((h, i) => (
                            <div key={i} className="flex-1 flex flex-col justify-end gap-2 group">
                                <motion.div 
                                    ...
                                    className={`w-full rounded-t-lg opacity-80 group-hover:opacity-100 transition-opacity ${i === 5 ? 'bg-gradient-to-t from-brand-green to-emerald-400' : 'bg-gradient-to-t from-brand-blue/50 to-brand-blue'}`} 
                                />
                    ...
                    {/* Prediction Line */}
                    <svg className="absolute bottom-10 left-0 w-full h-48 pointer-events-none opacity-50" preserveAspectRatio="none">
                        <path d="M0 100 Q 300 150, 600 50 T 1200 80" fill="none" stroke="#CCFF00" strokeWidth="2" strokeDasharray="5 5" />
                    </svg>
                </div>
