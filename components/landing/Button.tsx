...
const Button: React.FC<ButtonProps> = ({
  ...
  const frontFace = "block transition-all duration-500 ease-[cubic-bezier(0.65,0.05,0,1)] group-hover:-translate-y-[150%] group-hover:rotate-x-90";
  const backFace = "absolute inset-0 flex items-center justify-center transition-all duration-500 ease-[cubic-bezier(0.65,0.05,0,1)] translate-y-[150%] rotate-x-[-90deg] group-hover:translate-y-0 group-hover:rotate-x-0";
