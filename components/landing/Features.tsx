    ...
    <section className="py-24 lg:py-32 bg-brand-white">
      <div className="container mx-auto px-4">
        <AnimatedSection className="mb-16 md:mb-24">
          <h2 className="max-w-4xl font-display text-6xl font-bold leading-[0.85] tracking-tighter uppercase md:text-8xl lg:text-9xl">
            YOUR POCKET <br />
            <span className="text-brand-orange text-outline">AI ACCOUNTANT.</span>
          </h2>
        </AnimatedSection>
            ...
            <AnimatedSection>
              <div className="group relative flex min-h-[500px] flex-col justify-between overflow-hidden rounded-[2.5rem] border-2 border-black bg-brand-light p-8 shadow-hard transition-all hover:shadow-hard-lg lg:p-12 hover:-translate-y-2">
                <div className="relative z-10 max-w-lg">
                  <h3 className="mb-6 font-display text-5xl font-bold uppercase leading-none md:text-7xl tracking-tight">AI Prediction Engine</h3>
                  <p className="mb-8 text-xl font-medium leading-relaxed text-gray-800 md:text-2xl font-sans">
                  ...
                  <button className="flex items-center gap-2 rounded-full border-2 border-black bg-brand-yellow px-8 py-4 text-xl font-bold uppercase font-display tracking-wider transition-transform group-hover:scale-105">
          ...
          <div className="flex flex-col gap-8 lg:col-span-5">
            <AnimatedSection delay={0.2}>
              <div className="group relative flex min-h-[300px] flex-col justify-center overflow-hidden rounded-[2.5rem] border-2 border-black bg-brand-violet p-8 shadow-hard transition-all hover:shadow-hard-lg hover:-translate-y-2">
                <h3 className="mb-4 font-display text-4xl font-bold uppercase md:text-5xl tracking-tight">Ask the LLM</h3>
            ...
            <AnimatedSection delay={0.4}>
              <div className="group relative flex min-h-[300px] flex-col justify-center overflow-hidden rounded-[2.5rem] border-2 border-black bg-brand-green p-8 shadow-hard transition-all hover:shadow-hard-lg hover:-translate-y-2">
                <h3 className="mb-4 font-display text-4xl font-bold uppercase md:text-5xl tracking-tight">Data Analytics</h3>
